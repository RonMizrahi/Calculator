...
public class MongoDb implements DbController {
	...
	private void ConnectDatabase(){
		...
		//MongoClientURI uri  = new MongoClientURI("mongodb://shtukelman:S123456@ds131932.mlab.com:31932/mathdatabase");
		//MongoClientURI uri  = new MongoClientURI("mongodb://shtukelman:S123456@ds131932.mlab.com:31932/mathdatabase");
		//System.out.println(user.getIpaddress()+user.getUsername()+":"+user.getPassword()+"@ds1"+user.getPort()+".mlab.com:"+user.getPassword()+"/mathdatabase");
	    MongoClientURI uri  = new MongoClientURI(user.getIpaddress()+user.getUsername()+":"+user.getPassword()+"@ds1"+user.getPort()+".mlab.com:"+user.getPort()+"/mathdatabase");
